...
function fnGetDivisionsByRegions () {
    var jsonDivision_g = '';
    $.ajax({
        url: '../HiDoctor_Master/Division/GetDivisionsBasedonLoggedUser/',
        type: "POST",
        data: "A",
...
function  fnBindEntity  (jsonDivison_g) {
    ...
    if (jsonDivison_g != '') {
        ...
        tblContent = '';
        tblContent += '<div class="col-lg-12 form-group" style="font-style:italic;">This User is not Mapped to any Divison.</div>';
