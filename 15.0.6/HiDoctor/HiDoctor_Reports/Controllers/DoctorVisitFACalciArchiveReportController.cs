...
namespace HiDoctor_Reports.Controllers
{
    ...
    public class DoctorVisitFACalciArchiveReportController : Controller
    {
       ...
       // _objCurInfo = new CurrentInfo();
        JSONConverter _objJson = new JSONConverter();
        #endregion Private Variables
        //
        // GET: /DoctorVisitFACalciArchiveReport/
        ...
        public ActionResult AsyncDoctorVisitsFACalciArchiveReport()
        {
