    ...
    fnGetdcrdoctorsSucesscallback: function (response) {
        ...
        if (response.list.length > 0) {
            ...
            for (var i = 0; i < response.list.length; i++) {
                ...
                if (DF.length > 0) {
                    content += '<label class="col-6 col-sm-6 col-form-label localArea_label" id="diseaseflag' + i + '"> ' + DF + '</label>';
                }
                else {
                    var DF = '-';
                    content += '<label class="col-6 col-sm-6 col-form-label localArea_label" id="diseaseflag' + i + '">' + DF + '</label>';
                ...
                content += '</div>';
                content += '<div class="form-group row no-gutters">';
                content += '<label class="col-6 col-sm-6 col-form-label" style="font-weight:600;">Feed Back:</label>';
                if (response.list[i].Remarks != null) {
