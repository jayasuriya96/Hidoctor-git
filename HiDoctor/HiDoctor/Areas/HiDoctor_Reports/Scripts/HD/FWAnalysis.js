...
function fnGetUnderUserTypes() {
    $.ajax({
        type: "POST",
        url: '../HiDoctor_Reports/FWAnalysis/GetUnderUserType',
        data: "A",
...
function fnGetUnderUserTypeCount() {
    $.ajax({
        type: "POST",
        url: '../HiDoctor_Reports/FWAnalysis/GetUnderUserTypeCount',
...
function fnGetFWAnanlysisDetails() {
    ...
    $.ajax({
        type: "POST",
        url: '../HiDoctor_Reports/FWAnalysis/GetFWAnanlysisDetails',
...
function fnBindUserDetails(rowIndex) {
    ...
    $.ajax({
        type: "POST",
        url: '../HiDoctor_Reports/FWAnalysis/GetChildUserDetails',
...
function fnGetFWADayWorkedAnalysis(rowIndex) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetDaysWorkeddDtails',
        type: "POST",
...
function fnGetFWADoctorCallAnalysis(rowIndex) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/FWGetDoctorCallAnalysisdetails',
        type: "POST",
        data: "userCode=" + userCode + "&month=" + month + "&year=" + year + "&mode=" + mode + "&userTypeName=" + userTypeName + "",
        success: function (response) {
            $("#dvFWAnalysisReport").append("<div style='clear:both'></div><br />");
...
function fnGetChemistCallAnalysis(rowIndex) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/FWGetChemistCallAnalysis',
        type: "POST",
        data: "userCode=" + userCode + "&month=" + month + "&year=" + year + "&mode=" + mode + "&userTypeName=" + userTypeName + "",
        success: function (response) {
            $("#dvFWAnalysisReport").append("<div style='clear:both'></div><br />");
...
function fnGetFWADoctorVisitsFrequencyAnalysisReport(rowIndex) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/FWGetVisitsFrequencyAnalysis',
        type: "POST",
        data: "userCode=" + userCode + "&month=" + month + "&year=" + year + "&mode=" + mode + "&userTypeName=" + userTypeName + "",
        success: function (response) {
            $("#dvFWAnalysisReport").append("<div style='clear:both'></div><br />");
...
function fntotalApprovedDoctorspopup(val, obj) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetDoctorDetailPopup',
        type: "POST",
...
function fntotallistedDrs(val, obj) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetlistedDoctorDetailPopup',
        type: "POST",
        data: "userCode=" + val.split('_')[0] + "&category=" + val.split('_')[1] + "&month=" + val.split('_')[2] + "&year=" + val.split('_')[3],
        success: function (response) {
            $("#divModel").html(response);
...
function fnFrequencyPopUp(val, obj) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetlistedDrFreqAchievedPop',
        type: "POST",
...
function fnChemistPopup(val) {
    $.blockUI();
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetChemistDetailPopup',
        type: "POST",
...
function fnstockiestPopup(val) {
    $.blockUI();
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetStockiestDetailPopup',
        type: "POST",
        data: "userCode=" + val.split('_')[0] + "&month=" + val.split('_')[1] + "&year=" + val.split('_')[2] + "&entity=" + val.split('_')[3] + "&mode=" + val.split('_')[5],
        success: function (response) {
            $("#divModel").html(response);
...
function fnindependentPopup(val) {
    $.blockUI();
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetIndependentdrsDetailPopup',
        type: "POST",
        data: "userCode=" + val.split('_')[0] + "&month=" + val.split('_')[1] + "&year=" + val.split('_')[2] + "&entity=" + val.split('_')[3] + "&mode=" + val.split('_')[5],
        success: function (response) {
            var header = val.split('_')[4];
...
function fnDayanalysis(val) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/GetDaywiseAnalysis',
        type: "POST",
...
function fnGetFWAJointFieldWorkAnalysisReport(rowIndex) {
    ...
    $.ajax({
        url: '../HiDoctor_Reports/FWAnalysis/FWGetJointWorkAnalysis',
        type: "POST",
        data: "userCode=" + userCode + "&month=" + month + "&year=" + year + "&mode=" + mode + "&userTypeName=" + userTypeName + "",
        success: function (response) {
            $("#dvFWAnalysisReport").append("<div style='clear:both'></div><br />");
...
function fnGetDrvisitFrequencyAnalysiscals() {
    ...
    $.ajax({
        ...
        data: "userCode=" + userCode + "&month=" + month + "&year=" + year + "&mode=" + mode + "&userTypeName=" + userTypeName + "",
        success: function (response) {
            $("#dvDrvisitfrequency").append("<div style='clear:both'></div><br />");
            $("#dvDrvisitfrequency").append(response.split('*')[0]);
            $("#dvDrvisitfrequency").append("<br />");
            $("#dvDrvisitfrequency").append(response.split('*')[1]);
            $("#dvDrvisitfrequency").show();
            $("#DrvisitdivPrint").html($("#dvDrvisitfrequency").html());
            if ($.fn.dataTable) {
                $('#tbl_FWADoctorvisitAnanlysis').dataTable({
                    "sPaginationType": "full_numbers", "bDestroy": true, "sDom": 'T<"clear">lfrtip', "oTableTools": { "sSwfPath": "/Content/ZeroClipboard.swf" }
                });
