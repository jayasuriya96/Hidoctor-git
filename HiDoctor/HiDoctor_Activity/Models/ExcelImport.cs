...
namespace HiDoctor_Activity.Models
{
    ...
    {
        public static DataSet ImportExcelXLS(HttpPostedFileBase file, bool hasHeaders)
        {
        ...
        public static DataSet ImportExcelXML(HttpPostedFileBase file, bool hasHeaders, bool autoDetectColumnType)
        {
            Stream st = (Stream)file.InputStream;
        ...
        public static DataSet ImportExcelXML(Stream inputFileStream, bool hasHeaders, bool autoDetectColumnType)
        {
            ...
            XmlTextReader reader = new XmlTextReader(inputFileStream);
            doc.Load(reader);
        ...
        private static ColumnType getType(XmlNode data)
        {
            ...
            if (data == null)
                type = "";
            else if (data.Attributes["ss:Type"] == null || data.Attributes["ss:Type"].Value == null)
                type = "";
            else
